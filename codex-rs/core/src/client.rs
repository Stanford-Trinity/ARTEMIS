...
impl ModelClient {
    ...
    pub async fn stream(&self, prompt: &Prompt) -> Result<ResponseStream> {
        match self.provider.wire_api {
            ...
            WireApi::Chat => {
                ...
                let response_stream =
                    stream_chat_completions(prompt, &self.model, &self.client, &self.provider, self.specialist.as_deref())
                        .await?;
    ...
    async fn stream_responses(&self, prompt: &Prompt) -> Result<ResponseStream> {
        ...
        let full_instructions = prompt.get_full_instructions(&self.model, self.specialist.as_deref());
